...
parser.add_argument("--config", dest="config", action="store", default="C:/Users/natha/Desktop/WORK/openalpr_32/openalpr.conf",
                  help="Path to openalpr.conf config file" )

parser.add_argument("--runtime_data", dest="runtime_data", action="store", default="C:/Users/natha/Desktop/WORK/openalpr_32/runtime_data/",
...
try:
    ...
    if not alpr.is_loaded():
        ...
        jpeg_bytes = open('C:/Users/natha/Desktop/car_plate.jpg', "rb").read()
